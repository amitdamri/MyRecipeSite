    ...
    <div>
      <b-card :title="recipe.title" tag="article" class="mb-2" :style="style">
        ...
        params: { type: 'api', recipeId: recipe.id },
          ...
          <b-card :to="{ name: 'recipe', params: { type: 'api', recipeId: recipe.id } }" :img-src="recipe.image"
            img-alt="Image" img-top @click="markAsWatched()">
          </b-card>
        </router-link>
            ...
            <li>
                <div style="float: left;">
                    <button class="clickable" @click="saveFavorite">
                      <img src="../../resources/favorite.png" width="12" height="12"/>
                    </button>
              </div>
                <div style="float: left;">
